...
declare type webhooks = Record<string, never>;
...
declare type SchemaPet = components['schemas']['Pet'];
declare type SchemaApiResponse = components['schemas']['ApiResponse'];
declare type RequestBodyPet = components['requestBodies']['Pet'];
declare type RequestBodyUserArray = components['requestBodies']['UserArray'];
declare type $defs = Record<string, never>;
